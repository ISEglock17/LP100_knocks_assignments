...
# 学習の実行
num_epochs = 10
train_loss, train_acc, valid_loss, valid_acc = train_model(model, dataloaders_dict, criterion, optimizer, num_epochs)
...
# レイアウトの調整と保存
plt.tight_layout()
plt.savefig('./assignments_folder/Chapter8/fig75.png')
