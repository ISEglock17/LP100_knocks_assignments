...
for C in C_values:
    ...
    print(f"【正則化パラメーター: {C}】\n")
    print(f"train精度: {train_accuracies}")
    print(f"valid精度: {valid_accuracies}")
    print(f"test精度: {test_accuracies}\n")
...
train精度: [0.43744728703964014, 0.7888670227719988]
valid精度: [0.43670411985018726, 0.7752808988764045]
test精度: [0.46741573033707867, 0.8]

【正則化パラメーター: 0.1】

train精度: [0.43744728703964014, 0.7888670227719988, 0.7979570799362758]
valid精度: [0.43670411985018726, 0.7752808988764045, 0.7820224719101123]
test精度: [0.46741573033707867, 0.8, 0.8104868913857678]

【正則化パラメーター: 1】

train精度: [0.43744728703964014, 0.7888670227719988, 0.7979570799362758, 0.9510823727860557]
valid精度: [0.43670411985018726, 0.7752808988764045, 0.7820224719101123, 0.898876404494382]
test精度: [0.46741573033707867, 0.8, 0.8104868913857678, 0.9093632958801499]

【正則化パラメーター: 10】

train精度: [0.43744728703964014, 0.7888670227719988, 0.7979570799362758, 0.9510823727860557, 0.9983131852684847]
valid精度: [0.43670411985018726, 0.7752808988764045, 0.7820224719101123, 0.898876404494382, 0.9295880149812734]
test精度: [0.46741573033707867, 0.8, 0.8104868913857678, 0.9093632958801499, 0.9265917602996254]

【正則化パラメーター: 100】

train精度: [0.43744728703964014, 0.7888670227719988, 0.7979570799362758, 0.9510823727860557, 0.9983131852684847, 0.9994377284228282]
valid精度: [0.43670411985018726, 0.7752808988764045, 0.7820224719101123, 0.898876404494382, 0.9295880149812734, 0.9280898876404494]
test精度: [0.46741573033707867, 0.8, 0.8104868913857678, 0.9093632958801499, 0.9265917602996254, 0.9265917602996254]
"""
